...
## Module 01 - AI and LLM Fundamentals for Developers
...
#### 1.1.1 Teachable Machine - Training a Model based on a Dataset
...
#### 1.2 - Machine Learning, Deep Learning and AI
...
#### 1.3 - Deep Learning - Recommendation Systems in Practice

##### 1.3.1
Project in [example00](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-00/)
...
##### 1.3.2 How to Build an Intelligent Recommendation System with Neural Networks in the Browser

Project in [example01](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-01/)

- https://github.com/recommenders-team/recommenders
- https://www.databricks.com/blog/guide-to-building-online-recommendation-system

### 1.4 - Module - Web Machine Learning - How to Beat Any Game

Project in [example02](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-02/)
...
### 5 - Module - Artificial Intelligence on the Web
...
#### 5.2 - How LLMs Work: Transformers, Embeddings, Attention
...
#### 5.3 - Web AI - How Artificial Intelligence Works on the Web with Web AI

Project in [example-03-webai01](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-03-webai01/)

Project in [example-04-webai02-temperature-and-topK](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-04-webai02-temperature-and-topK/)
...
#### 5.4 - Web AI - Multimodal AI Directly in Browsers

Project in [example-05-webai03-multimodal/](./modulo01-fundamentos-de-ia-e-llms-para-programadores/demos/exemplo-05-webai03-multimodal/)
...
### 6 - Module - Prompt Engineering in Practice

#### 6.1 - How to Write Prompts That Actually Generate Good Answers
...
#### 6.2 - TOON and JSON Pattern for Prompts
...
### 7 - Module - AI Tools to Accelerate Your Life as a Dev

#### 7.1 - History and Overview of Cursor, Comparing VSCode, Windsurf, and Cursor
...
#### 7.2 - What AI Agents Are and How They Make Step-by-Step Decisions
...
### 8 - Module - MCPs and Automation for Devs

#### 8.1 - What MCPs (Model Context Protocol) Are and How They Connect AI with APIs/Services

Project in [erickwendel-contributions-mcp/](https://github.com/ErickWendel/erickwendel-contributions-mcp)
